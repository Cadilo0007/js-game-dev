...
function slideLeft(){
	for(let r=0; r<rows; r++){
		...
		for(let c=0; c<columns; c++){
            ...
            // line for animation
            // if current tile != to original tile, apply animation
            if(originalRow[c] !== num && num !== 0){
            	// specify the animation style and duration
            	tile.style.animation = "slide-from-right 0.3s"

            	// remove the animation clas after animation is complete
            	setTimeout(() => {
...
// event listener to capture touch in the screen andd assigns the x and y coordiates in the starx and starty variable
